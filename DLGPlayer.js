...
export default class DLGPlayer extends Component {
  ...
  render () {
    ...
    return (
      <RCTDLGPlayer ref={this._assignRoot} {...nativeProps} />
    )
  }
}
...
const RCTDLGPlayer = requireNativeComponent('RCTDLGPlayer', DLGPlayer)
